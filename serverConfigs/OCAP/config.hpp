ocap_minPlayerCount = 16; // recording will only begin if this many players are in the server
ocap_minMissionTime = 60; // missions must last at least this many minutes to be saved

...
_playerData = profileNameSpace getVariable format ["Player_Data_%1_%2", "OIF", "OIF03"];
...
while {true} do {
  ...
  profileNameSpace setVariable [format ["Player_Data_%1_%2", "OIF", "OIF03"], [_loadout, _med, _eng]];

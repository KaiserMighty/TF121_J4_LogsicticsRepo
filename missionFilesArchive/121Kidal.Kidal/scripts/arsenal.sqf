...
_makoItems = ["121_Mighty_Aviation_Nods","121_Mighty_FlightHelmet_Night_Stow","121_Mighty_FlightHelmet_Night","121_Mighty_FlightHelmet_Day","121_Mighty_FlightHelmet_Day_Stow","121_Mighty_SurvivalVest","121_Mighty_SurvivalVest_Cold","121_Mighty_uFlightsuit","121_Mighty_uFlightsuit_Cold"];
_makoBlacklist = ["kat_PainkillerItem","tsp_popperCharge_mag","tsp_popperCharge_auto_mag"];
_soarItems = [];
_stsItems = ["24_sheg_rd","PJCryeG3","PJCryeG3_Full","PJCryeG2_roll","CryeG2","PJRubgy","PJPCU"];
_sustItems = [];
_jregItems = [];
...
_tempItems = "'STS_' in (configName _x)" configClasses (configFile >> "CfgWeapons") apply {configName _x};
_stsItems append _tempItems;
_tempItems = "'PJ_' in (configName _x)" configClasses (configFile >> "CfgVehicles") apply {configName _x};
_stsItems append _tempItems;
